...
class Helper:
  ...
  async def on_message(self, message):
    ...
    if message.content.startswith('.help'):
      ...
      embed.add_field(name='[chicken server](https://discord.gg/9hjAVpP)', value= '** **', inline=True)
      embed.add_field(name='[chicken website](http://chickenserver.wix.com/website)', value= '** **', inline=False)
